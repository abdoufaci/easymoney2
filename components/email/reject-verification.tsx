...
export default function RejectVerification({ name, link }: Props) {
  return (
    <div
      style={{
      ...
      <div style={{ padding: "0 15px" }}>
        ...
        <p
          ...
          We&apos;ve reviewed your verification request, but unfortunately, we
          couldn&apos;t approve it.
        </p>
        ...
        <ul
          ...
          <li style={{ margin: "8px 0" }}>A blurry or unclear ID photo</li>
          <li style={{ margin: "8px 0" }}>An invalid or expired document</li>
          <li style={{ margin: "8px 0" }}>
            Details that don&apos;t match your account
          </li>
        </ul>
        ...
        <p
          ...
          Please re-upload a valid and clear ID to try again.
        </p>
        ...
        <p
          ...
          If you believe this is a mistake or need help, feel free to contact
          our support team.
        </p>
